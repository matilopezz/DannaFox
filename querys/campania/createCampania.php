    ...
    if(isset($_POST['crear_campania'])){
        ...
        $text_SMS = trim($_POST['sms_text']);
        $localidad_id = implode(',' , $_POST['ciudades']);  // Convierte el array en una cadena separada por comas
        ...
        $insertQuery = "INSERT INTO campanias (cliente_id, text_SMS, localidad_id, cantidad_mensajes, nombre_campania, estado, fecha_inicio) VALUES (?, ?, ?, ?, ?, ?, ?)";
